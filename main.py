...
headingLabel = Label(headingFrame1, text="Welcome to \n Ioana's Library!", bg='black',
                     fg='white', font=('Times New Roman', 20))
headingLabel.place(relx=0, rely=0, relwidth=1, relheight=1)

addButton = Button(root, text="Add Book Details", bg='black', fg='white',
                   font=('Times New Roman', 15), command=add_book)
addButton.place(relx=0.28, rely=0.4, relwidth=0.45, relheight=0.1)

deleteButton = Button(root, text="Delete Book", bg='black', fg='white',
                      font=('Times New Roman', 15))
deleteButton.place(relx=0.28, rely=0.55, relwidth=0.45, relheight=0.1)

viewButton = Button(root, text="View Book List", bg='black', fg='white',
                    font=('Times New Roman', 15), command=view_books)
